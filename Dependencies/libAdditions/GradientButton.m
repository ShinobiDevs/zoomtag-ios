...
- (void) setHighlightGradientLocations: (NSArray *) array
{
    ...
    highlightGradientLocations = array;
}
...
- (void) setStyle:(NSString*)style {
    SEL styleSel = NSSelectorFromString([NSString stringWithFormat:@"use%@Style",style]);
    if ([self respondsToSelector:styleSel]) {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Warc-performSelector-leaks"
        [self performSelector:styleSel withObject:nil];
